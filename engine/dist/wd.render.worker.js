	...
	*/
	    ...
	    return map$2((function () {
	                  return e;
	                            ...
	                            return Promise.resolve(setState$1(stateData, state));
	                              ...
	                              var state = unsafeGetState$1(stateData);
	                              state[/* imguiRecord */27] = init$3(unsafeGetGl(state[/* deviceManagerRecord */4]), /* tuple */[
	...
	function execJob$15(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                state[/* vboBufferRecord */23] = disposeSourceInstanceVboBuffer(data.sourceInstanceNeedDisposeVboBufferArr, disposeCustomGeometryVboBuffer(data.customGeometryNeedDisposeVboBufferArr, disposeBoxGeometryVboBuffer(data.boxGeometryNeedDisposeVboBufferArr, state[/* vboBufferRecord */23])));
	                setState$1(stateData, state);
	                return e;
	              }));
	}
	...
	function createTypeArrays$5(buffer, count) {
	  return /* tuple */[
	...
	function createTypeArrays$6(buffer, basicSourceTextureCount) {
	  return /* tuple */[
	...
	function getRecord$13(param) {
	  return unsafeGet$1(param[/* basicSourceTextureRecord */14]);
	}
	...
	function addSource(texture, source, sourceMap) {
	  requireCheck((function () {
	          return test(buildAssertMessage("sourceMap in texture:" + (String(texture) + " should exist source before"), "exist"), (function () {
	                        return assertFalse(has$1(texture, sourceMap));
	                      }));
	        }), getIsDebug(stateData));
	  return set$1(texture, source, sourceMap);
	}
	...
	function _addSource(texture, imageBitmap, state) {
	  requireCheck((function () {
	          var match = getRecord$13(state);
	          var sourceMap = match[/* sourceMap */8];
	          return test(buildAssertMessage("sourceMap shouldn\'t has source before", "has"), (function () {
	                        return assertFalse(hasSource(texture, sourceMap));
	                      }));
	        }), getIsDebug(stateData));
	  var match = getRecord$13(state);
	...
	function createTypeArrays$7(buffer, basicSourceTextureCount, arrayBufferViewSourceTextureCount) {
	  return /* tuple */[
	...
	function getRecord$14(param) {
	  return unsafeGet$1(param[/* arrayBufferViewSourceTextureRecord */15]);
	}
	...
	function setSourceMap(sourceMap, state) {
	  var record = getRecord$14(state);
	  var newrecord = caml_array_dup(state);
	  newrecord[/* arrayBufferViewSourceTextureRecord */15] = /* record */[
	...
	function _createTypeArrays(buffer, basicSourceTextureCount, arrayBufferViewSourceTextureCount, state) {
	  var match = createTypeArrays$6(buffer, basicSourceTextureCount);
	  ...
	  var match$1 = createTypeArrays$7(buffer, basicSourceTextureCount, arrayBufferViewSourceTextureCount);
	...
	function _buildInitTextureStream(e, stateData) {
	  return callFunc((function () {
	                ...
	                var data = getRecord$1(e);
	                var textureData = data.textureData;
	                var basicSourceTextureRecord = getRecord$13(state);
	                var arrayBufferViewSourceTextureRecord = getRecord$14(state);
	                state[/* basicSourceTextureRecord */14] = /* record */[
	...
	function _getLocation$2(param, getGlLocationFunc, gl) {
	...
	function createBuffer$6(gl, record, state) {
	...
	function createBuffer$7(gl, record, state) {
	...
	function isNeedUpdate$1(textureInTypeArray, _, isNeedUpdates, getIsNeedUpdateFunc) {
	  return getIsNeedUpdateFunc(textureInTypeArray, isNeedUpdates) === getDefaultIsNeedUpdate$1(/* () */0);
	}
	...
	function createBuffer$8(gl, capacity, state) {
	...
	function getOrCreateBuffer$3(param, param$1, state) {
	  ...
	  if (match !== undefined) {
	    ...
	    var buffer = createBuffer$8(param[0], _getCapacity(sourceInstance, param[2], param$1[0]), state);
	...
	function setCapacityAndUpdateBufferTypeArray(param, param$1, param$2, state) {
	  ...
	  if (needIncreaseCapacity) {
	    ...
	    var buffer$1 = createBuffer$8(gl, currentCapacity, state);
	...
	function getRecord$15(param) {
	  return unsafeGet$1(param[/* transformRecord */16]);
	}
	...
	function getRecord$19(param) {
	  return unsafeGet$1(param[/* basicMaterialRecord */12]);
	}

	function unsafeGetShaderIndices(state) {
	  return unsafeGet$1(getRecord$19(state)[/* shaderIndices */0]);
	}

	function unsafeGetMapUnits(state) {
	  return unsafeGet$1(getRecord$19(state)[/* mapUnits */3]);
	}


	/* OptionService-Wonderjs Not a pure module */

	function getRecord$20(param) {
	  return unsafeGet$1(param[/* lightMaterialRecord */13]);
	}

	function unsafeGetShaderIndices$1(state) {
	  return unsafeGet$1(getRecord$20(state)[/* shaderIndices */0]);
	}

	function unsafeGetDiffuseMapUnits(state) {
	  return unsafeGet$1(getRecord$20(state)[/* diffuseMapUnits */5]);
	}

	function unsafeGetSpecularMapUnits(state) {
	  return unsafeGet$1(getRecord$20(state)[/* specularMapUnits */6]);
	}
	...
	function getRecord$21(state) {
	  return unsafeGet$1(state[/* customGeometryRecord */18]);
	}


	/* OptionService-Wonderjs Not a pure module */

	function getRecord$22(param) {
	...
	function getPositionMap$1(record) {
	  return unsafeGet$1(record[/* positionMap */1]);
	}
	...
	function createRenderState(state) {
	  ...
	  var transformRecord = getRecord$15(state);
	  var boxGeometryRecord = getRecord$17(state);
	  var customGeometryRecord = getRecord$21(state);
	  var basicMaterialRecord = getRecord$19(state);
	  var lightMaterialRecord = getRecord$20(state);
	  var directionLightRecord = getRecord$22(state);
	  var pointLightRecord = getRecord$16(state);
	  var basicSourceTextureRecord = getRecord$13(state);
	  var arrayBufferViewSourceTextureRecord = getRecord$14(state);
	  var workerDetectRecord = getRecord$18(state);
	  ...
	  return /* record */[
	          ...
	          /* directionLightRecord : record */[
	            ...
	            /* positionMap */getPositionMap$1(directionLightRecord)
	          ],
	...
	function _render(gl, state) {
	  ...
	  if (match !== undefined) {
	    ...
	    render$2(gl, /* tuple */[
	          ...
	          match$1[/* geometryIndices */3],
	          match$1[/* geometryTypes */4],
	...
	function label$1(rect, str, align, state) {
	  var __x = label(rect, str, align, getRecord$23(state));
	  return setRecord(__x, state);
	}

	function image$1(rect, uv, id, state) {
	  var __x = image(rect, uv, id, getRecord$23(state));
	  return setRecord(__x, state);
	}

	function button$2(rect, str, state) {
	  var match = button(rect, str, getRecord$23(state));
	  return /* tuple */[
	...
	function box$1(rect, color, state) {
	  var __x = box(rect, color, getRecord$23(state));
	  return setRecord(__x, state);
	}

	function radioButton$2(groupDataArr, defaultSelectIndex, group, state) {
	  var match = radioButton(groupDataArr, defaultSelectIndex, group, getRecord$23(state));
	  return /* tuple */[
	          setRecord(match[0], state),
	          match[1]
	        ];
	...
	function checkbox$2(rect, defaultIsSelected, str, state) {
	  var match = checkbox(rect, defaultIsSelected, str, getRecord$23(state));
	  return /* tuple */[
	          setRecord(match[0], state),
	          match[1]
	        ];
	...
	function beginGroup$1(position, state) {
	  var __x = beginGroup$2(position, getRecord$23(state));
	  return setRecord(__x, state);
	}

	function endGroup$1(state) {
	  var __x = endGroup$2(getRecord$23(state));
	  return setRecord(__x, state);
	}
	...
	function execJob$23(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                var data = getRecord$1(e);
	                var imguiData = data.imguiData;
	                var match = isJsonSerializedValueNone(imguiData.imguiFunc);
	                if (match) {
	                  return e;
	                } else {
	                  var imguiRecord = setControlData(imguiData.controlData, setIMGUIFunc$1(unsafeGetJsonSerializedValue(imguiData.customData), deserializeFunction(unsafeGetJsonSerializedValue(imguiData.imguiFunc)), getRecord$3(state)));
	                  state[/* imguiRecord */27] = imguiRecord;
	...
	function execJob$25(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                state[/* deviceManagerRecord */4] = setViewportData(viewportData, setViewportOfGl(unsafeGetGl(state[/* deviceManagerRecord */4]), viewportData, state[/* deviceManagerRecord */4]));
	                setState$1(stateData, state);
	                return e;
	              }));
	}
	...
	function _createTypeArrays$1(buffer, sourceInstanceCount, objectInstanceCountPerSourceInstance, state) {
	...
	function execJob$26(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                var state$1 = _createTypeArrays$1(sourceInstanceData.buffer, getSourceInstanceCount$1(settingRecord), getObjectInstanceCountPerSourceInstance$1(settingRecord), state);
	...
	function execJob$28(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	...
	function execJob$30(flags, _, _$1) {
	...
	function _createTypeArrays$2(buffer, count, state) {
	...
	function execJob$31(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                ...
	                setState$1(stateData, _createTypeArrays$2(buffer, count, state));
	                return e;
	              }));
	}
	...
	function execJob$34(flags, _, _$1) {
	  return createGetMainWorkerDataStream(flags, _1(getSelf, /* () */0));
	}
	...
	function execJob$36(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	...
	function getConstantsOffset() {
	  return imul(getColorsLength$1(/* () */0), Float32Array.BYTES_PER_ELEMENT) + imul(getIntensitiesLength(/* () */0), Float32Array.BYTES_PER_ELEMENT) | 0;
	}
	...
	function createTypeArrays$8(buffer, _) {
	  return /* tuple */[
	...
	function _createTypeArrays$3(buffer, count, index, state) {
	  var match = createTypeArrays$8(buffer, count);
	...
	function execJob$37(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, _createTypeArrays$3(buffer, count, pointLightData.index, state));
	                return e;
	              }));
	}
	...
	function execJob$44(flags, _, _$1) {
	  return createGetMainWorkerDataStream(flags, _1(getSelf, /* () */0));
	}
	...
	function execJob$45(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                var pointLightData = data.pointLightData;
	...
	function init$7(gl, param, initMaterialFunc, param$1) {
	...
	function _getShaderIndex$2(key, param) {
	...
	function initMaterialShader$1(materialIndex, param, param$1, param$2) {
	  ...
	  var match = _getShaderIndex$2(key, shaderRecord);
	  if (match !== undefined) {
	    return match;
	  } else {
	...
	function init$6(gl, instanceTuple, state) {
	  var materialRecord = state[/* materialRecord */0];
	  return init$7(gl, instanceTuple, initMaterial, /* tuple */[
	...
	function createInitMaterialState(state) {
	  ...
	  return /* record */[
	          ...
	          /* renderConfigRecord */getRecord$29(state),
	...
	function _createTypeArrays$4(buffer, basicMaterialCount, textureCountPerMaterial, state) {
	...
	function execJob$46(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                var basicMaterialData = data.basicMaterialData;
	                ...
	                setState$1(stateData, initMaterials(/* tuple */[
	                          ...
	                          init$6
	                        ], getRecord$19(state)[/* isSourceInstanceMap */6], _createTypeArrays$4(basicMaterialData.buffer, basicMaterialCount, textureCountPerMaterial, state)));
	                return e;
	              }));
	}
	...
	function send(gl, param, param$1) {
	  ...
	  reduceOneParam((function (pointLightRecord, index) {
	          ...
	          sendVec3(gl, uniformCacheMap, /* tuple */[
	              ...
	              ], getPosition$3(index, positionMap));
	...
	function createTypeArrays$9(buffer, _) {
	  return /* tuple */[
	...
	function init$8(gl, instanceTuple, state) {
	  var materialRecord = state[/* materialRecord */0];
	  return init$7(gl, instanceTuple, initMaterial$2, /* tuple */[
	              materialRecord[/* index */0],
	              materialRecord[/* disposedIndexArray */1],
	              state
	            ]);
	...
	function _createTypeArrays$5(buffer, lightMaterialCount, textureCountPerMaterial, state) {
	...
	function execJob$47(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                var lightMaterialData = data.lightMaterialData;
	                ...
	                setState$1(stateData, initMaterials(/* tuple */[
	                          ...
	                          init$8
	                        ], getRecord$20(state)[/* isSourceInstanceMap */9], _createTypeArrays$5(lightMaterialData.buffer, lightMaterialCount, textureCountPerMaterial, state)));
	                return e;
	              }));
	}
	...
	function _createTypeArrays$6(buffer, geometryPointCount, geometryCount, state) {
	  var match = createTypeArrays$3(buffer, geometryPointCount, geometryCount);
	  state[/* customGeometryRecord */18] = /* record */[
	    /* vertices */match[0],
	    /* texCoords */match[1],
	    /* normals */match[2],
	    /* indices */match[3],
	...
	function execJob$53(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                ...
	                setState$1(stateData, _createTypeArrays$6(buffer, customGeometryPointCount, customGeometryCount, state));
	                return e;
	              }));
	}
	...
	function _createTypeArrays$7(buffer, count, index, state) {
	  var match = createTypeArrays$9(buffer, count);
	...
	function execJob$54(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                ...
	                setState$1(stateData, _createTypeArrays$7(buffer, count, directionLightData.index, state));
	                return e;
	              }));
	}
	...
	function execJob$55(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	...
	function execJob$56(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                state[/* renderConfigRecord */2] = create$28(/* tuple */[
	...
	function execJob$60(flags, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                postMessage({
	                      ...
	                      imguiData: {
	                        controlData: getControlData(getRecord$3(state))
	                      }
	                    }, _1(getSelf, /* () */0));
	                return e;
	              }));
	...
	function execJob$62(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                var directionLightData = data.directionLightData;
	...
	function execJob$64(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                initData.directionLightData;
	                initData.pointLightData;
	                var gl = unsafeGetGl(state[/* deviceManagerRecord */4]);
	...
	var execJob$65 = execJob$66;


	/* SendWorkerDataJobUtils-Wonderjs Not a pure module */

	var execJob$67 = execJob$66;
	...
	function execJob$68(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var match = isRender(getRecord$1(e));
	                if (match) {
	                  execJob$69(createRenderState(state));
	                  setState$1(stateData, state);
	                  return e;
	                } else {
	                  return e;
	...
	function execJob$70(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                state[/* glslSenderRecord */8] = execJob$71(state[/* glslSenderRecord */8]);
	                setState$1(stateData, state);
	                return e;
	              }));
	}
	...
	function execJob$79(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                ...
	                if (match) {
	                  ...
	                  var match$1 = createTypeArrays$5(basicRenderData.buffer, basicRenderData.bufferCount);
	...
	function execJob$80(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                var match = isRender(data);
	                if (match) {
	                  ...
	                  var match$1 = createTypeArrays$5(lightRenderData.buffer, lightRenderData.bufferCount);
	...
	function create$38() {
	  return /* record */[/* ambientLight : record */[/* color */getDefaultColor(/* () */0)]];
	}
	...
	function createState() {
	  return /* record */[
	          ...
	          /* deviceManagerRecord */create$35(/* () */0),
	          /* shaderRecord */create$30(/* () */0),
	          /* programRecord */create$31(/* () */0),
	          /* glslRecord */create$29(/* () */0),
	          /* glslSenderRecord */create$36(/* () */0),
	          /* glslLocationRecord */create$34(/* () */0),
	          /* glslChunkRecord */create$25(/* () */0),
	          /* sourceInstanceRecord */create$20(/* () */0),
	          ...
	          /* boxGeometryRecord */create$19(/* () */0),
	          /* customGeometryRecord */undefined,
	          /* directionLightRecord */undefined,
	          /* pointLightRecord */undefined,
	          /* renderRecord */create$40(/* () */0),
	          /* typeArrayPoolRecord */create$37(/* () */0),
	          /* vboBufferRecord */create$32(/* () */0),
	          /* globalTempRecord */create$33(/* () */0),
	          /* workerDetectRecord */undefined,
	          /* browserDetectRecord */undefined,
	          /* imguiRecord */createRecord$1(/* () */0),
	          /* apiRecord */create$21(/* () */0),
	          /* customRecord */create$39(/* () */0)
	        ];
	}
