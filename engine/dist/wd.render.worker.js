(function (global, factory) {
	...
	*/
	...
	function createBuffer$4(gl, record, state) {
	...
	function _sendAttributeData(gl, indexTuple, state) {
	  ...
	  if (exit === 1) {
	    record[/* lastSendGeometryData */11] = geometryIndex;
	...
	function _drawTexture$1(gl, param, param$1) {
	  ...
	  _1(_setUnpackAlignmentaToOne, gl);
	...
	/* _setUnpackAlignmentaToOne Not a pure module */
	...
	function createRenderState(state) {
	  ...
	  return /* record */[
	          ...
	          /* geometryRecord : record */[
	            ...
	            /* verticesInfos */geometryRecord[/* verticesInfos */4],
	            /* texCoordsInfos */geometryRecord[/* texCoordsInfos */5],
	            /* normalsInfos */geometryRecord[/* normalsInfos */6],
	            /* indicesInfos */geometryRecord[/* indicesInfos */7]
	          ],
	...
	function _createTypeArrays$1(buffer, geometryPointCount, geometryCount, state) {
	...
	function execJob$26(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, _createTypeArrays$1(buffer, geometryPointCount, geometryCount, state));
	                return e;
	              }));
	}
	...
	function createTypeArrays$6(buffer, meshRendererCount) {
	...
	function createTypeArrays$7(buffer, basicMaterialCount, textureCountPerMaterial) {
	  return /* tuple */[
	...
	function createTypeArrays$8(buffer, lightMaterialCount, textureCountPerMaterial) {
	  return /* tuple */[
	...
	function _createTypeArrays$4(buffer, count, index, state) {
	...
	function execJob$38(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, _createTypeArrays$4(buffer, count, pointLightData.index, state));
	                return e;
	              }));
	}
	...
	function _createTypeArrays$5(buffer, meshRendererCount, state) {
	  var drawModes = createTypeArrays$6(buffer, meshRendererCount);
	...
	function execJob$43(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, _createTypeArrays$5(buffer, meshRendererCount, state));
	                return e;
	              }));
	}
	...
	function execJob$46(flags, _, _$1) {
	  return createGetMainWorkerDataStream(flags, _1(getSelf, /* () */0));
	}
	...
	function _createTypeArrays$6(buffer, basicMaterialCount, textureCountPerMaterial, state) {
	  var match = createTypeArrays$7(buffer, basicMaterialCount, textureCountPerMaterial);
	  var basicMaterialRecord = getRecord$14(state);
	  state[/* basicMaterialRecord */12] = /* record */[
	...
	function execJob$48(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, initMaterials(/* tuple */[
	                          ...
	                          init$5
	                        ], getRecord$14(state)[/* isSourceInstanceMap */6], _createTypeArrays$6(basicMaterialData.buffer, basicMaterialCount, textureCountPerMaterial, state)));
	                return e;
	              }));
	}
	...
	function _createTypeArrays$7(buffer, lightMaterialCount, textureCountPerMaterial, state) {
	  var match = createTypeArrays$8(buffer, lightMaterialCount, textureCountPerMaterial);
	  var lightMaterialRecord = getRecord$15(state);
	  state[/* lightMaterialRecord */13] = /* record */[
	    /* shaderIndices */some$1(match[0]),
	...
	function execJob$49(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, initMaterials(/* tuple */[
	                          ...
	                          init$7
	                        ], getRecord$15(state)[/* isSourceInstanceMap */9], _createTypeArrays$7(lightMaterialData.buffer, lightMaterialCount, textureCountPerMaterial, state)));
	                return e;
	              }));
	}
	...
	/* RemoveComponentGameObjectMainService-Wonderjs Not a pure module */
