(function (global, factory) {
	...
	*/
	...
	function getRecord$2(param) {
	  return unsafeGet$1(param[/* browserDetectRecord */27]);
	}
	  ...
	  if (match) {
	    ...
	    return map$2((function () {
	                  return e;
	                            ...
	                            state[/* imguiRecord */28] = imguiRecord;
	                            return Promise.resolve(setState$1(stateData, state));
	                              ...
	                              var state = unsafeGetState$1(stateData);
	                              state[/* imguiRecord */28] = init$3(unsafeGetGl(state[/* deviceManagerRecord */4]), /* tuple */[
	                                    imguiData.canvasWidth,
	                                    imguiData.canvasHeight
	                                  ], setCustomImageArr$1(customImageArr, state[/* imguiRecord */28]));
	                              return Promise.resolve(setState$1(stateData, state));
	                            })))));
	  }
	}
	...
	function execJob$15(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                state[/* vboBufferRecord */24] = disposeSourceInstanceVboBuffer(data.sourceInstanceNeedDisposeVboBufferArr, disposeCustomGeometryVboBuffer(data.customGeometryNeedDisposeVboBufferArr, disposeBoxGeometryVboBuffer(data.boxGeometryNeedDisposeVboBufferArr, state[/* vboBufferRecord */24])));
	                setState$1(stateData, state);
	                return e;
	              }));
	}
	...
	function _createTypeArrays(buffer, basicSourceTextureCount, arrayBufferViewSourceTextureCount, state) {
	  ...
	  var match$1 = createTypeArrays$8(buffer, basicSourceTextureCount, arrayBufferViewSourceTextureCount);
	...
	function _buildInitTextureStream(e, stateData) {
	  return callFunc((function () {
	                ...
	                var data = getRecord$1(e);
	                var textureData = data.textureData;
	                var basicSourceTextureRecord = getRecord$14(state);
	                var arrayBufferViewSourceTextureRecord = getRecord$15(state);
	                state[/* basicSourceTextureRecord */15] = /* record */[
	...
	function createBuffer$9(gl, capacity, state) {
	...
	function getOrCreateBuffer$3(param, param$1, state) {
	  ...
	  if (match !== undefined) {
	    ...
	    var buffer = createBuffer$9(param[0], _getCapacity(sourceInstance, param[2], param$1[0]), state);
	...
	function setCapacityAndUpdateBufferTypeArray(param, param$1, param$2, state) {
	  ...
	  if (needIncreaseCapacity) {
	    ...
	    var buffer$1 = createBuffer$9(gl, currentCapacity, state);
	...
	function getCameraRecord$1(state) {
	  return state[/* renderRecord */22][/* cameraRecord */2];
	}

	function getBasicRenderObjectRecord$1(state) {
	  return state[/* renderRecord */22][/* basicRenderObjectRecord */0];
	}

	function getLightRenderObjectRecord$1(state) {
	  return state[/* renderRecord */22][/* lightRenderObjectRecord */1];
	}
	...
	function getRecord$17(param) {
	  return unsafeGet$1(param[/* pointLightRecord */21]);
	}
	...
	function getRecord$18(state) {
	  return state[/* boxGeometryRecord */18];
	}
	...
	function getRecord$20(param) {
	  return unsafeGet$1(param[/* workerDetectRecord */26]);
	}


	/* OptionService-Wonderjs Not a pure module */

	function getRecord$21(param) {
	  return unsafeGet$1(param[/* basicMaterialRecord */12]);
	}

	function unsafeGetShaderIndices(state) {
	  return unsafeGet$1(getRecord$21(state)[/* shaderIndices */0]);
	}

	function unsafeGetMapUnits(state) {
	  return unsafeGet$1(getRecord$21(state)[/* mapUnits */3]);
	}
	...
	function unsafeGetShaderIndices$1(state) {
	  return unsafeGet$1(getRecord$22(state)[/* shaderIndices */0]);
	}

	function unsafeGetDiffuseMapUnits(state) {
	  return unsafeGet$1(getRecord$22(state)[/* diffuseMapUnits */5]);
	}

	function unsafeGetSpecularMapUnits(state) {
	  return unsafeGet$1(getRecord$22(state)[/* specularMapUnits */6]);
	}
	...
	function getRecord$23(state) {
	  return unsafeGet$1(state[/* customGeometryRecord */19]);
	}


	/* OptionService-Wonderjs Not a pure module */

	function getRecord$24(param) {
	  return unsafeGet$1(param[/* directionLightRecord */20]);
	}
	...
	function createRenderState(state) {
	  ...
	  var typeArrayPoolRecord = state[/* typeArrayPoolRecord */23];
	  var vboBufferRecord = state[/* vboBufferRecord */24];
	  var globalTempRecord = state[/* globalTempRecord */25];
	  var transformRecord = getRecord$16(state);
	  var boxGeometryRecord = getRecord$18(state);
	  var customGeometryRecord = getRecord$23(state);
	  var basicMaterialRecord = getRecord$21(state);
	  var lightMaterialRecord = getRecord$22(state);
	  var meshRendererRecord = getRecord$19(state);
	  var directionLightRecord = getRecord$24(state);
	  var pointLightRecord = getRecord$17(state);
	  var basicSourceTextureRecord = getRecord$14(state);
	  var arrayBufferViewSourceTextureRecord = getRecord$15(state);
	  var workerDetectRecord = getRecord$20(state);
	  ...
	  return /* record */[
	          ...
	          /* shaderRecord : record */[/* usedShaderIndexArray */shaderRecord[/* usedShaderIndexArray */2]],
	...
	function label$1(rect, str, align, state) {
	  var __x = label(rect, str, align, getRecord$25(state));
	  return setRecord(__x, state);
	}

	function image$1(rect, uv, id, state) {
	  var __x = image(rect, uv, id, getRecord$25(state));
	  return setRecord(__x, state);
	}

	function button$2(rect, str, state) {
	  var match = button(rect, str, getRecord$25(state));
	  return /* tuple */[
	...
	function box$1(rect, color, state) {
	  var __x = box(rect, color, getRecord$25(state));
	  return setRecord(__x, state);
	}

	function radioButton$2(groupDataArr, defaultSelectIndex, group, state) {
	  var match = radioButton(groupDataArr, defaultSelectIndex, group, getRecord$25(state));
	  return /* tuple */[
	          setRecord(match[0], state),
	          match[1]
	        ];
	...
	function checkbox$2(rect, defaultIsSelected, str, state) {
	  var match = checkbox(rect, defaultIsSelected, str, getRecord$25(state));
	  return /* tuple */[
	          setRecord(match[0], state),
	          match[1]
	        ];
	...
	function beginGroup$1(position, state) {
	  var __x = beginGroup$2(position, getRecord$25(state));
	  return setRecord(__x, state);
	}

	function endGroup$1(state) {
	  var __x = endGroup$2(getRecord$25(state));
	  return setRecord(__x, state);
	}
	...
	function execJob$28(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                state[/* renderRecord */22][/* cameraRecord */2] = (match == null) ? undefined : /* record */[
	...
	function _createTypeArrays$4(buffer, meshRendererCount, state) {
	  ...
	  state[/* meshRendererRecord */14] = /* record */[/* drawModes */drawModes];
	  return state;
	}
	...
	function execJob$45(flags, _, _$1) {
	  return createGetMainWorkerDataStream(flags, _1(getSelf, /* () */0));
	}
	...
	function execJob$47(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, initMaterials(/* tuple */[
	                          ...
	                          init$6
	                        ], getRecord$21(state)[/* isSourceInstanceMap */6], _createTypeArrays$5(basicMaterialData.buffer, basicMaterialCount, textureCountPerMaterial, state)));
	                return e;
	              }));
	}
	...
	function send(gl, param, param$1) {
	  ...
	  reduceOneParam((function (pointLightRecord, index) {
	          ...
	          sendVec3(gl, uniformCacheMap, /* tuple */[
	              ...
	              ], getPosition$2(index, positionMap));
	...
	function createTypeArrays$10(buffer, _) {
	  return /* tuple */[
	...
	function send$2(gl, param, param$1) {
	  ...
	  reduceOneParam((function (directionLightRecord, index) {
	          ...
	          sendVec3(gl, uniformCacheMap, /* tuple */[
	              ...
	              ], getDirection$1(index, directionMap));
	          sendFloat3(gl, uniformCacheMap, /* tuple */[
	                color,
	                getUniformLocation(program, color, uniformLocationMap, gl)
	...
	function execJob$48(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, initMaterials(/* tuple */[
	                          ...
	                          init$8
	                        ], getRecord$22(state)[/* isSourceInstanceMap */9], _createTypeArrays$6(lightMaterialData.buffer, lightMaterialCount, textureCountPerMaterial, state)));
	                return e;
	              }));
	}
	...
	function _createTypeArrays$7(buffer, geometryPointCount, geometryCount, state) {
	  var match = createTypeArrays$4(buffer, geometryPointCount, geometryCount);
	  state[/* customGeometryRecord */19] = /* record */[
	    /* vertices */match[0],
	    /* texCoords */match[1],
	    /* normals */match[2],
	    /* indices */match[3],
	...
	function execJob$54(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, _createTypeArrays$7(buffer, customGeometryPointCount, customGeometryCount, state));
	                return e;
	              }));
	}
	...
	function _createTypeArrays$8(buffer, count, index, state) {
	...
	function execJob$55(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                setState$1(stateData, _createTypeArrays$8(buffer, count, directionLightData.index, state));
	                return e;
	              }));
	}
	...
	function execJob$58(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                state[/* workerDetectRecord */26] = /* record */[/* isUseWorker */workerDetectData.isUseWorker];
	                setState$1(stateData, state);
	                return e;
	              }));
	}
	...
	function execJob$59(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                state[/* browserDetectRecord */27] = /* record */[/* browser */browserDetectData.browser];
	                setState$1(stateData, state);
	                return e;
	              }));
	}
	...
	function execJob$65(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var data = getRecord$1(e);
	                var initData = data.initData;
	...
	var execJob$66 = execJob$67;


	/* SendWorkerDataJobUtils-Wonderjs Not a pure module */

	var execJob$68 = execJob$67;
	...
	function execJob$69(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                var match = isRender(getRecord$1(e));
	                if (match) {
	                  execJob$70(createRenderState(state));
	                  setState$1(stateData, state);
	                  return e;
	                } else {
	                  return e;
	...
	function execJob$71(_, e, stateData) {
	  return callFunc((function () {
	                var state = unsafeGetState$1(stateData);
	                state[/* glslSenderRecord */8] = execJob$72(state[/* glslSenderRecord */8]);
	                setState$1(stateData, state);
	                return e;
	              }));
	}
	...
	function execJob$80(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                if (match) {
	                  ...
	                  var match$1 = createTypeArrays$6(basicRenderData.buffer, basicRenderData.bufferCount);
	                  state[/* renderRecord */22][/* basicRenderObjectRecord */0] = /* record */[
	...
	function execJob$81(_, e, stateData) {
	  return callFunc((function () {
	                ...
	                if (match) {
	                  ...
	                  var match$1 = createTypeArrays$6(lightRenderData.buffer, lightRenderData.bufferCount);
	                  state[/* renderRecord */22][/* lightRenderObjectRecord */1] = /* record */[
	...
	function createState() {
	  return /* record */[
	          ...
	          /* sourceInstanceRecord */create$21(/* () */0),
